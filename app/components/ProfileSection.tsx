	...
	return (
		<div className="w-full py-8 md:py-0 bg-white dark:bg-black px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center
							bg-[radial-gradient(closest-side,theme(colors.emerald.white),theme(colors.white),theme(colors.white))]
							dark:bg-[radial-gradient(closest-side,theme(colors.emerald.900),theme(colors.emerald.950),theme(colors.black))]
							py-10">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Jasraj Sandhu</h1>
				...
				<div className="space-y-2">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						{/* <a href="mailto:jasrajsandhu01@gmail.com" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							jasrajsandhu01@gmail.com
						</a> */}
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Calgary, AB</span>
					</div>
					...
					<div className="flex items-center justify-center space-x-4">
						...
						<a
							href="https://www.linkedin.com/in/jasraj-sandhu-91b548164/"
							target="_blank"
							rel="noopener noreferrer"
							className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
						>
